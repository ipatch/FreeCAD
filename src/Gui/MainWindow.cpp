...
void MainWindow::setActiveWindow(MDIView* view)
{
    ...
    const bool activeViewChanged = (view != d->activeView);

    Base::Console().message(
        "setActiveWindow: view = %s, activeView = %s, changed = %d -> steal = %d\n",
        view ? view->metaObject()->className() : "null",
        d->activeView ? d->activeView->metaObject()->className() : "null",
        activeViewChanged,
        activeViewChanged
    );
