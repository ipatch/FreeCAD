    ...
    def test_part_children_preserve_their_own_names(self):
        ...
        try:
            ...
            try:
                ...
                part_features = [
                    obj for obj in import_doc.Objects if obj.isDerivedFrom("Part::Feature")
                ]
                ...
                self.assertEqual(
                    pad_count, 0, f"Tip feature name 'PadA' should not appear: {imported_labels}"
                )
    ...
    def test_standalone_body_preserves_name(self):
        ...
        try:
            ...
            try:
                ...
                self.assertEqual(
                    imported_label, "MyTestBody", f"Expected 'MyTestBody', got '{imported_label}'"
                )
